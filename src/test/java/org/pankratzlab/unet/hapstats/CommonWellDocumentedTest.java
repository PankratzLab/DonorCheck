...
public class CommonWellDocumentedTest {
  ...
  public void CommonWellDocumented_valueOf() {
    ...
    List<HLAType> x = new ArrayList<>(Arrays.asList(HLAType.valueOf("A*24:03:03"),
        HLAType.valueOf("A*01:02"), HLAType.valueOf("B*15:63")));
    assertEquals(1.5, CommonWellDocumented.cwdScore(x));
    // cwdScore: two commons and a well documented
    List<HLAType> y = new ArrayList<>(Arrays.asList(HLAType.valueOf("DRB4*03:01N"),
        HLAType.valueOf("B*46:01:01"), HLAType.valueOf("B*15:71")));
    assertEquals(2.0, CommonWellDocumented.cwdScore(y));
    // cwdScore: three unknowns
    List<HLAType> z = new ArrayList<>(Arrays.asList(HLAType.valueOf("A*29:13"),
        HLAType.valueOf("B*18:27"), HLAType.valueOf("DRB1*16:11")));
