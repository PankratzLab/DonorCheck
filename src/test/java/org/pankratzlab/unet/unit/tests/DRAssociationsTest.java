...
public class DRAssociationsTest {
  ...
  public void DRAssociations_getDRBLocus() {
    ...
    assertEquals(
        HLALocus.valueOf("DRB3"), DRAssociations.getDRBLocus(new SeroType("DRB3", 3)).get());
    // value in the table and DRB4
    assertEquals(
        HLALocus.valueOf("DRB4"), DRAssociations.getDRBLocus(new SeroType("DRB4", 07)).get());
    // value in the table and DRB5
    assertEquals(
        HLALocus.valueOf("DRB5"), DRAssociations.getDRBLocus(new SeroType("DRB5", 16)).get());
